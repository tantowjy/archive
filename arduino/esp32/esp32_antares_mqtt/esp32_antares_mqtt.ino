...
#define ACCESSKEY "e112c26b405394dc:2c6c8478a7dc4cf0"       // Antares account access key
#define WIFISSID "PQ"         // Wi-Fi SSID to connect to
#define PASSWORD "12345678"     // Wi-Fi password

#define projectName "IOT_K1"   // Name of the application created in Antares
#define deviceName "device"     // Name of the device created in Antares
